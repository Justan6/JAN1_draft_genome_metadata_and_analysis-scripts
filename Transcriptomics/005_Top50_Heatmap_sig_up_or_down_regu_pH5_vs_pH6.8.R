...
# Heatmaps: TPM (pH5/pH6.8) and log2FoldChange with product annotation
#=================================================================================================
...
#=================================================================================================
input_file <- "results/DEGs/pH5_vs_pH68_TPM_log2TPM_by_condition.csv"
...
# Ensure numeric
numeric_cols <- c("TPM_5.0", "TPM_6.8", "log2TPM_5.0", "log2TPM_6.8", "log2FoldChange", "padj")
...
#=================================================================================================
max_log2TPM <- max(c(top50$log2TPM_5.0, top50$log2TPM_6.8), na.rm = TRUE)
col_fun <- colorRamp2(
...
# TPM matrices
#=================================================================================================
mat_5.0_log <- matrix(top50$log2TPM_5.0, ncol = 1, dimnames = list(NULL, "5.0 (pH 5.0)"))
mat_6.8_log  <- matrix(top50$log2TPM_6.8, ncol = 1, dimnames = list(NULL, "6.8 (Control)"))
mat_5.0_raw <- matrix(top50$TPM_5.0, ncol = 1)
...
ht_5.0 <- Heatmap(
  ...
  column_title = "pH 5.0 (Low pH)",
  cell_fun = function(j, i, x, y, width, height, fill) {
    grid.text(sprintf("%.1f", mat_5.0_raw[i, j]), x, y, gp = gpar(fontsize = 11))
  },
  width = unit(3, "cm")
)
...
ht_list_tpm <- ht_6.8 + ht_5.0 + row_anno
...
#=================================================================================================
# Combine all heatmaps (pH 5.0, pH 6.8, log2FC)
#=================================================================================================
ht_list_all <- ht_6.8 + ht_5.0 + ht_fc + row_anno + row_anno_pro

#=================================================================================================
# Save outputs
#=================================================================================================
pdf(file.path(output_dir, "1.pH5.0_vs_pH6.8_Top50_up_downregulated_log2FC_product_overlay.pdf"), width = 20, height = 10)
draw(ht_list_all, heatmap_legend_side = "bottom")
dev.off()

png(file.path(output_dir, "1.pH5.0_vs_pH6.8_Top50_up_downregulated_log2FC_product_overlay.png"), width = 1500, height = 800, res = 150)
draw(ht_list_all, heatmap_legend_side = "bottom")
dev.off()

svg(file.path(output_dir, "1.pH5.0_vs_pH6.8_Top50_up_downregulated_log2FC_product_overlay.svg"), width = 20, height = 10)
draw(ht_list_all, heatmap_legend_side = "bottom")
dev.off()
